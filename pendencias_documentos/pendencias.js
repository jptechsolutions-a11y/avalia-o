// --- CONFIGURAÇÕES E CONSTANTES ---
    ...
    async function loadInitialData() {
        showLoading(true, 'Carregando dados de pendências...');
    ...
    async function handleImport() {
        ...
        // --- REMOVIDO: VERIFICAÇÃO DE DUPLICATAS NA ENTRADA DO USUÁRIO ---
        // Removido a pedido do usuário, pois as duplicatas são permitidas pela regra de negócio.
        ...
        try {
            ...
            await loadInitialData(); // Recarrega os dados do Supabase
